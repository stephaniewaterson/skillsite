...
function ResponsiveItems({ layout }) {
  return (
    <group position={[layout.projectsX, layout.projectsY, 0]} className="items">
      <Items />
    </group>
  );
}
                  ...
                  <Suspense>
                    ...
                    <group position={[layout.skillsX, layout.skillsY, 0]}>
                      ...
                      {layout.showSpaceMan && open && (
                        <SpaceMan
                          position={[layout.spaceManX, layout.spaceManY, 0]}
                          scale={6}
                        />
                      )}
                    </group>

                    <ResponsiveItems layout={layout} />
                  </Suspense>
                </Scroll>
